---
title: "Traceability-Based Findings v 1.2"
...
+ Prepare labresults (in googlequery) table to allow merge on inventorycombinations

**Later To Do's**

+ Improve/validate data cleaning for THC/CBD content for retail tables.
